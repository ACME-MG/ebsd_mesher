...
for decrease in [5,6,7,8,9,10]:

    itf = Interface(f"617_s1_d{decrease}_z{z_elements}")
    ...
    itf.decrease_resolution(decrease) # 50
    itf.fill(20)
    itf.clean(3)
    itf.smooth(3)
    # itf.add_grips(15)
    itf.add_grips(round(150/decrease))
    ...
    itf.mesh("~/cubit/psculpt.exe", z_elements=z_elements)
